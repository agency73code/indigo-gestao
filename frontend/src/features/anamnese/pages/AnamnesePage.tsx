...
const initialDesenvolvimentoInicial: Partial<AnamneseDesenvolvimentoInicial> = {
    ...
    neuropsicomotor: {
        sustentouCabeca: { meses: '', naoRealiza: false },
        rolou: { meses: '', naoRealiza: false },
        sentou: { meses: '', naoRealiza: false },
        engatinhou: { meses: '', naoRealiza: false },
        andouComApoio: { meses: '', naoRealiza: false },
        andouSemApoio: { meses: '', naoRealiza: false },
        correu: { meses: '', naoRealiza: false },
        andouDeMotoca: { meses: '', naoRealiza: false },
        andouDeBicicleta: { meses: '', naoRealiza: false },
        subiuEscadasSozinho: { meses: '', naoRealiza: false },
        motricidadeFina: '',
    },
    falaLinguagem: {
        balbuciou: { meses: '', nao: false },
        primeirasPalavras: { meses: '', nao: false },
        primeirasFrases: { meses: '', nao: false },
        apontouParaFazerPedidos: { meses: '', nao: false },
        fazUsoDeGestos: null,
        fazUsoDeGestosQuais: '',
        audicao: null,
