    ...
    '1': {
        ...
        desenvolvimentoInicial: {
            ...
            falaLinguagem: {
                ...
                tuboVentilacaoObservacao: 'Uso de tubo de ventilação bilateral por 2 anos devido a otites recorrentes',
        ...
        atividadesVidaDiaria: {
            ...
            alimentacao: {
                ...
                estaAbaixoOuAcimaPeso: 'sim',
                estaAbaixoOuAcimaPesoDescricao: 'Peso 22kg, altura 1,15m. Está acima do peso. Faz acompanhamento com nutricionista mensalmente.',
                temHistoricoAnemia: 'sim',
                temHistoricoAnemiaDescricao: 'Desde os 3 anos de idade. Faz suplementação de ferro sob orientação médica.',
                rotinaAlimentarEProblemaFamilia: 'sim',
                rotinaAlimentarEProblemaFamiliaDescricao: 'Hora das refeições é muito estressante. Recusa frequente, choro e demora excessiva para comer.',
        ...
        socialAcademico: {
            ...
            desenvolvimentoAcademico: {
                ...
                periodo: 'Matutino',
                direcao: 'Maria Silva',
                coordenacao: 'Ana Santos',
                professoraPrincipal: 'Carla Oliveira',
                professoraAssistente: 'Beatriz Costa',
                // Campos Sim/Não
                frequentaEscolaRegular: 'sim',
                frequentaEscolaEspecial: 'sim',
                acompanhaTurmaDemandasPedagogicas: 'sim',
                segueRegrasRotinaSalaAula: 'nao',
                necessitaApoioAT: 'sim',
                necessitaAdaptacaoMateriais: 'sim',
                necessitaAdaptacaoCurricular: 'sim',
                houveReprovacaoRetencao: 'nao',
                escolaPossuiEquipeInclusao: 'sim',
                haIndicativoDeficienciaIntelectual: 'nao',
                escolaApresentaQueixaComportamental: 'sim',
                // Campos descritivos
                ...
                observacoes: 'Necessita de apoio constante para manter foco nas atividades',
            },
        },
        comportamento: {
