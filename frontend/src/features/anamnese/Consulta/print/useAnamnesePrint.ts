/**
 * Hook para impressão de anamnese
 * Baseado no usePrint do relatório
 */
...
export function useAnamnesePrint({
    content,
    documentTitle = 'anamnese',
    onBeforeGetContent,
    onAfterPrint,
    onPrintError,
}: UseAnamnesePrintOptions) {
    ...
    const handlePrint = useCallback(async () => {
        ...
        try {
            ...
            console.warn('Erro ao configurar listener de mídia:', error);
        }
