...
const MOCK_TERAPEUTA: TerapeutaOption = {
    id: 'terapeuta-001',
    nome: 'Ana Paula Fernandes Silva',
    avatarUrl: undefined,
};
...
const MOCK_TERAPEUTAS: TerapeutaOption[] = [
    MOCK_TERAPEUTA,
    { id: 'terapeuta-002', nome: 'Carlos Eduardo Santos Mendes', avatarUrl: undefined },
    { id: 'terapeuta-003', nome: 'Mariana Oliveira Costa Lima', avatarUrl: undefined },
    { id: 'terapeuta-004', nome: 'Roberto Almeida Ferreira', avatarUrl: undefined },
    { id: 'terapeuta-005', nome: 'Juliana Santos Pereira', avatarUrl: undefined },
];

// Exportar para uso em outros mocks se necessário
export { MOCK_TERAPEUTAS };

// Dados completos dos clientes (para uso nos relatórios)
const MOCK_CLIENTES_COMPLETOS: Record<string, { nome: string; dataNascimento: string; avatarUrl?: string }> = {
    'cli-001': { nome: 'Miguel Oliveira', dataNascimento: '02/01/2018', avatarUrl: undefined },
    'cli-002': { nome: 'Sofia Santos', dataNascimento: '15/06/2020', avatarUrl: undefined },
    'cli-003': { nome: 'Lucas Ferreira', dataNascimento: '23/03/2019', avatarUrl: undefined },
    'cli-004': { nome: 'Helena Costa', dataNascimento: '10/11/2017', avatarUrl: undefined },
};
...
// Exportar dados completos dos clientes
export { MOCK_CLIENTES_COMPLETOS };
...
const MOCK_LANCAMENTOS: ItemFaturamento[] = [
    ...
    },
    {
        ...
        clienteIdade: '5 anos',
        clienteDataNascimento: '15/06/2020',
        data: '2026-01-23',
        horarioInicio: '08:00',
        horarioFim: '09:00',
        tipoAtividade: TIPO_ATIVIDADE_FATURAMENTO.CONSULTORIO,
    ...
    },
    {
        ...
        terapeutaId: MOCK_TERAPEUTA.id,
        terapeutaNome: MOCK_TERAPEUTA.nome,
        terapeutaRegistroProfissional: 'CRP 06/123456',
        clienteId: undefined,
...
const MOCK_LANCAMENTOS_OUTROS_TERAPEUTAS: ItemFaturamento[] = [
    // Carlos Eduardo - Terapeuta 002
    {
        ...
        terapeutaNome: 'Carlos Eduardo Santos Mendes',
        terapeutaRegistroProfissional: 'CRP 06/234567',
        clienteId: 'cli-002',
        clienteNome: 'Sofia Santos',
        data: '2026-01-24',
        horarioInicio: '10:00',
    ...
    // Mariana Oliveira - Terapeuta 003
    {
        ...
        terapeutaNome: 'Mariana Oliveira Costa Lima',
        terapeutaRegistroProfissional: 'CREFITO 3/345678',
        clienteId: 'cli-001',
        clienteNome: 'Miguel Oliveira',
        data: '2026-01-25',
        horarioInicio: '08:00',
    ...
    // Roberto Almeida - Terapeuta 004
    {
        ...
        terapeutaNome: 'Roberto Almeida Ferreira',
        terapeutaRegistroProfissional: 'CREFITO 3/456789',
        clienteId: 'cli-003',
        clienteNome: 'Lucas Ferreira',
        data: '2026-01-24',
        horarioInicio: '15:00',
    ...
    // Juliana Santos - Terapeuta 005
    {
        ...
        terapeutaNome: 'Juliana Santos Pereira',
        terapeutaRegistroProfissional: 'MT 06/567890',
        clienteId: 'cli-004',
        clienteNome: 'Helena Costa',
        data: '2026-01-25',
        horarioInicio: '09:00',
