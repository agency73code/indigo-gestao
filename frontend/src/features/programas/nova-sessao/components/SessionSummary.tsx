...
export default function SessionSummary({ summary }: SessionSummaryProps) {
    ...
    if (totalAttempts === 0) {
        return (
            <Card className="rounded-[5px] mb-24 sm:mb-0 px-6 py-2 md:px-8 md:py-10 lg:px-8 lg:py-0">
    ...
    return (
        <Card className="rounded-[5px] mb-32 lg:mb-0 px-6 py-2 md:px-8 md:py-10 lg:px-8 lg:py-0">
            <CardHeader className="pb-2 sm:pb-3 pt-3 sm:pt-6">
                <CardTitle className="text-base flex items-center gap-2">
                    <TrendingUp className="h-4 w-4" />
                    Resumo da Sessão
