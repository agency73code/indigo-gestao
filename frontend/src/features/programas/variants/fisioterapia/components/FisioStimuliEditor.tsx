...
import ToStimulusRow from './FisioStimulusRow';

interface ToStimuliEditorProps {
    stimuli: {
        id?: string;
        label: string;
...
export default function ToStimuliEditor({
    stimuli,
    onStimuliChange,
    errors,
}: ToStimuliEditorProps) {
        ...
        <Card padding="small" className="rounded-[5px]">
            ...
            <CardContent className="pb-3 sm:pb-6">
                ...
                <div className="space-y-3">
                    ...
                    {/* Botão adicionar atividade no final da lista */}
                    {stimuli.length > 0 && (
                        <Button
                            type="button"
                            onClick={handleAddStimulus}
