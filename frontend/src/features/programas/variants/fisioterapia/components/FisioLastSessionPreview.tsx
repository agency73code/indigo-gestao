 ...
 * Versão adaptada de LastSessionPreview para Fisioterapia
 * 
...
function StatusBadge({ activity }: StatusBadgeProps) {
    ...
    let predominantStatus: FisioStatusKind;
    ...
    const config = FISIO_STATUS_CONFIG[predominantStatus];
