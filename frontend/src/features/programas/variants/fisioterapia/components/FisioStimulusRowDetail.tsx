...
import ToStimulusEvolutionInline from './FisioStimulusEvolutionInline';

interface ToStimulusRowDetailProps {
    programId: string;
    stimulus: {
        id: string;
        order: number;
...
export default function ToStimulusRowDetail({
    programId,
    stimulus,
    muted = false,
}: ToStimulusRowDetailProps) {
