...
import ToStimulusRowDetail from './FisioStimulusRowDetail';

interface ToStimuliSectionProps {
    program: {
        id: string;
...
export default function ToStimuliSection({ program }: ToStimuliSectionProps) {
