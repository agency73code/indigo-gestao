...
} from './FisioActivityBlockPanel';
import type { FisioProgramDetail, FisioSessionAttempt, FisioPerformanceType } from '../types';
...
interface ToActivitiesPanelProps {
    program: FisioProgramDetail;
    attempts: FisioSessionAttempt[];
    onAddAttempt: (attempt: FisioSessionAttempt) => void;
    sessionId?: string;
}
...
export default function ToActivitiesPanel({
    ...
    const [tempAttempts, setTempAttempts] = useState<Record<string, FisioSessionAttempt[]>>({});
