...
export default function ToSessionFiles({ files, onFilesChange, disabled = false }: ToSessionFilesProps) {
    ...
    const handleFileSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            setFileName(''); // Campo vazio - usuário deve digitar
        }
    };
                ...
                {selectedFile && (
                    <div className="p-4 bg-muted/50 rounded-lg space-y-3">
                        ...
                        <div className="flex gap-2">
                            <Button type="button" onClick={handleAddFile} disabled={!fileName.trim() || disabled} size="sm" className="flex-1">
                                Adicionar
                            </Button>
                            <Button
                                type="button"
                ...
                {files.length > 0 ? (
                    <div className="space-y-2">
                        ...
                        {files.map((file) => {
                            ...
                            return (
                                <div key={file.id} className="flex items-center gap-2 p-2 bg-card border rounded-lg">
                    ...
                    <p className="text-center text-sm text-muted-foreground py-4">Nenhum arquivo anexado</p>
                )}
            </CardContent>
        </Card>
    );
