...
import type { Patient, FisioProgramDetail } from '../types';

interface ToHeaderSessionInfoProps {
    patient: Patient;
    program: FisioProgramDetail;
}

export default function ToHeaderSessionInfo({ patient, program }: ToHeaderSessionInfoProps) {
