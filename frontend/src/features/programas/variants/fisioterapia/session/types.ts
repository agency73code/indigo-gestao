/**
 * Tipos específicos para Sessão de Fisioterapia
 * 
 * 🔧 CONVENÇÃO DE NOMENCLATURA:
 * - FisioPerformanceType (kebab-case): Usado em API e identificadores React
 * - FisioSessionSummary (camelCase): Usado em estado JavaScript e contadores
 * 
...
export type FisioPerformanceType = 'nao-desempenhou' | 'desempenhou-com-ajuda' | 'desempenhou';

export type FisioSessionAttempt = {
    id: string;
    attemptNumber: number;
    activityId: string; // Em Fisio usamos "atividade" ao invés de "estímulo"
 ...
 */
export type FisioSessionSummary = {
...
// Tipo específico para Programa Fisio (com estrutura de atividades)
export type FisioProgramDetail = {
    id: string;
