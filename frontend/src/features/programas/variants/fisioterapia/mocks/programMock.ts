/**
 * Mock de programa de Fisioterapia para desenvolvimento
 * Este mock simula um programa completo de Fisio com todos os campos específicos
 */
...
export const mockToProgram = {
    ...
    stimuliApplicationDescription: '', // Fisio não usa este campo
    criteria: '', // Fisio não usa critérios de aprendizagem
