...
/**
 * Serviço mock para buscar programa de Fisio
 * Use este serviço temporariamente até o backend de Fisio estar pronto
 */
export async function fetchToProgramById(id: string): Promise<typeof mockToProgram> {
    // Simular delay de rede
    await new Promise(resolve => setTimeout(resolve, 500));
    
    console.log('🎭 Usando MOCK de programa Fisio para id:', id);
