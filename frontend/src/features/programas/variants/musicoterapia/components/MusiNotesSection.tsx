...
interface MusiNotesSectionProps {
    notes: string;
    onNotesChange?: (notes: string) => void;
    readOnly?: boolean;
}

export default function MusiNotesSection({ notes, onNotesChange, readOnly = false }: MusiNotesSectionProps) {
        ...
        <Card padding="small" className="rounded-[5px]">
            ...
            <CardContent className="pb-3 sm:pb-6">
                <div className="space-y-2">
                    <Label htmlFor="notes">Observações adicionais sobre o programa de Musicoterapia (opcional)</Label>
                    <textarea
                        id="notes"
