// Componente de seleção de programa Musicoterapia para sessão
// Usa a mesma UI do ProgramSelector mas com lógica adaptada para Musicoterapia
...
interface MusiProgramSelectorProps {
...
export default function MusiProgramSelector({
    patient,
    selected,
    onSelect,
    onClear,
    autoOpenIfEmpty = false,
}: MusiProgramSelectorProps) {
    ...
    useEffect(() => {
        ...
        const timeoutId = setTimeout(async () => {
            setIsLoading(true);
            try {
                const { listMusiPrograms } = await import('../../services/api');
                const result = await listMusiPrograms({
