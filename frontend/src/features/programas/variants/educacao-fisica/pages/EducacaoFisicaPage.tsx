    ...
    const mainActions = [
        {
            ...
            icon: Plus,
            href: '/app/programas/novo-fisio?area=educacao-fisica',
        ...
        },
        {
            ...
            icon: FileText,
            href: '/app/programas/lista-fisio?area=educacao-fisica',
        ...
        },
        {
            ...
            icon: Eye,
            href: '/app/programas/sessoes-fisio/consultar?area=educacao-fisica',
        ...
        },
        {
            ...
            icon: ClipboardEdit,
            href: '/app/programas/sessoes-fisio/registrar?area=educacao-fisica',
