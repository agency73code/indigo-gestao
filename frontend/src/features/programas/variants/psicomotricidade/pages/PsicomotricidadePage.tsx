    ...
    const mainActions = [
        {
            ...
            icon: Plus,
            href: '/app/programas/novo-fisio?area=psicomotricidade',
        ...
        },
        {
            ...
            icon: FileText,
            href: '/app/programas/lista-fisio?area=psicomotricidade',
        ...
        },
        {
            ...
            icon: Eye,
            href: '/app/programas/sessoes-fisio/consultar?area=psicomotricidade',
        ...
        },
        {
            ...
            icon: ClipboardEdit,
            href: '/app/programas/sessoes-fisio/registrar?area=psicomotricidade',
