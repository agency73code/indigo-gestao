...
export default function PsicopedagogiaPage() {
    ...
    useEffect(() => {
        setCurrentArea('psicopedagogia');
        setPageTitle('Psicopedagogia');
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    >
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">Nenhum programa ainda</p>
                        </CardContent>
                    </Card>
                    ...
                    >
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">Nenhuma sessão hoje</p>
                        </CardContent>
                    </Card>
