...
export default function ToEditarProgramaPage() {
    ...
    useEffect(() => {
        setPageTitle('Editar Programa - TO');
    }, [setPageTitle]);
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const detailUrl = patientId 
                ? `${toRoutes.detail(programaId)}?patientId=${patientId}`
                : toRoutes.detail(programaId);
            navigate(detailUrl);
        } catch (err) {
    ...
    const handleCancel = () => {
        if (hasChanges) {
            const confirmed = window.confirm(toProgramConfig.messages.confirmLeave);
            if (!confirmed) return;
        }
    ...
    return (
        <div className="min-h-screen bg-background pb-4">
            <div className="max-w-lg md:max-w-none p-0 lg:p-4 space-y-6">
                ...
                <Card padding="small" className="rounded-[5px]">
                    ...
                    <CardContent className="pb-3 sm:pb-6 space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                id="goal-title"
                                placeholder="Ex: Desenvolver habilidades de autonomia"
                                value={goalTitle}
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                id="goal-description"
                                placeholder="Descreva o objetivo principal de TO..."
                ...
                <ToNotesSection notes={notes} onNotesChange={setNotes} />
