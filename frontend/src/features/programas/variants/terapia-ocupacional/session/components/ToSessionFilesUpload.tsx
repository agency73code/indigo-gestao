...
interface ToSessionFilesUploadProps {
    files: SessionFile[];
...
export default function ToSessionFilesUpload({
    files,
    onFilesChange,
    disabled = false,
}: ToSessionFilesUploadProps) {
            ...
            <CardContent className="pb-3 sm:pb-6 space-y-4">
                        ...
                        <div className="space-y-3 p-4 bg-muted/50 rounded-lg">
                            <div className="flex items-start gap-3">
                                <div className="text-2xl">
                                    {getFileEmoji(selectedFile.type).emoji}
                                </div>
                ...
                {files.length > 0 && (
                    <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                            {files.map((file) => {
                                const { emoji, color } = getFileEmoji(file.file.type);
                                return (
                                    <div
                                        key={file.id}
