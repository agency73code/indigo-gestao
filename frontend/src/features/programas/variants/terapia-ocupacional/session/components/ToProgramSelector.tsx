// Componente de seleção de programa TO para sessão
...
export default function ToProgramSelector({
    ...
    useEffect(() => {
        ...
        const timeoutId = setTimeout(async () => {
            setIsLoading(true);
            try {
                // Usar o serviço de TO ao invés de Fono
                const { listToPrograms } = await import('../../services/api');
                const result = await listToPrograms({
