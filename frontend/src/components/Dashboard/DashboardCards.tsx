...
const metricCards: MetricCardConfig[] = [
    {
        ...
        tooltip: 'Contagem de pacientes com acompanhamento vigente ou sessões futuras.',
        emptyState: 'Sem pacientes ativos agora.',
        ariaLabel: 'Total de pacientes ativos',
    ...
    },
    {
        ...
        subcopy: 'Programas em execução por paciente',
        tooltip: 'Soma de programas OCP ativos entre todos os pacientes.',
        emptyState: 'Nenhum programa OCP ativo.',
        ariaLabel: 'Total de programas OCP ativos',
        actionLabel: 'Ver por paciente',
        actionHref: '#',
        formatValue: (value) => value.toLocaleString('pt-BR'),
    },
    {
