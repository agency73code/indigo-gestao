...
const routeToTitleMap: Record<string, string> = {
    ...
    '/app/anamnese': 'Anamnese',
    '/app/anamnese/lista': 'Anamnese',
    '/app/anamnese/cadastro': 'Cadastrar Anamnese',
    ...
    '/app/programas/psicoterapia/cadastrar': 'Novo Prontuário',
    '/app/programas/psicoterapia/consultar': 'Consultar Prontuários',
