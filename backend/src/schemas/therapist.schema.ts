...
export const therapistSchema = z.object({
  ...
  email: z.string().min(1, 'E-mail pessoal é obrigatório').email({ message: 'E-mail pessoal inválido' }),
  emailIndigo: z.string().min(1, 'E-mail indigo é obrigatório').email({ message: 'E-mail indigo inválido' }),
