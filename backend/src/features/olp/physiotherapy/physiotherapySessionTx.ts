...
import type { PhysiotherapyInput } from "./types/PhysiotherapyInput.js";
import { parseLoadValue } from "./utils/parseLoadValue.js";
import { programNotFound } from "../../../errors/programNotFound.js";

export async function physiotherapySessionTx(tx: Tx, input: PhysiotherapyInput) {
    ...
    const trialsData = attempts.map((a) => {
        ...
        return {
            ...
            utilizou_carga: a.usedLoad,
            valor_carga: parseLoadValue(a.loadValue),
            teve_desconforto: a.hadDiscomfort,
            descricao_desconforto: a.discomfortDescription,
            teve_compensacao: a.hadCompensation,
            descricao_compensacao: a.compensationDescription,
        };
    });
