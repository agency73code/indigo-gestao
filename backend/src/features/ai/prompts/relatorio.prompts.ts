/**
 * Prompts para Relatórios Clínicos
 * @module features/ai/prompts
 */

export const PROMPTS_RELATORIO = {
    /** Prompt do sistema para resumo de observações clínicas */
    SYSTEM: `
...
export function buildRelatorioUserPrompt(params: {
    patientName: string;
    area: string;
    periodLabel: string;
...
export const RELATORIO_DISCLAIMER = 'Rascunho gerado por IA — exige validação clínica antes de uso.';
