...
async function main() {
    ...
    const fonoOcp = await prisma.ocp.create({
        data: {
            ...
            objetivo_programa:
                'Ampliação da compreensão e expressão oral em situações do cotidiano.',
            objetivo_descricao:
                ...
                create: [
                    {
                        ...
                        estimulo: {
                            create: {
                                ...
                                descricao:
                                    'Compreensão de comandos simples de 1 etapa em contexto lúdico e funcional.',
                            },
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        estimulo: {
                            create: {
                                ...
                                descricao:
                                    'Construção de frases simples a partir de estímulos visuais.',
                            },
                        },
                    },
                    {
                        ...
                        estimulo: {
                            create: {
                                nome: 'Relato breve de rotina diária',
                                descricao:
                                    'Relato de rotina diária com apoio de perguntas e figuras.',
                            },
                        },
                    },
                ],
